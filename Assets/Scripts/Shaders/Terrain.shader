        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            for (int i = 0; i < layerCount; i++)
            {
               ...
               heightPercent - baseStartHeights[i]);
                ...
                float3 textureColor = triplanar(IN.worldPos, baseTextureScales[i], blendAxes, i) * (1 - baseColorStrengths
                    [i]);
                o.Albedo = o.Albedo * (1 - drawStrength) + (textureColor+baseColor) * drawStrength;
            }
        }
        ENDCG
    }
